...
const AdaText = () => {
    ...
    return (
        ...
        <div className='text-gray-border'><p className='text-gray'>"lessons in the morning in arithmetic, grammar, spelling, reading, music, each no more than a quarter of an hour long - after dinner, geography, drawing, French, music, reading, all performed with alacrity and docility." (Hollings C, Martin U, Rice A, s.9)</p></div>
        ...
        <div className='text-gray-border'><p className='text-gray'>"Supposing that the fundamental relations of pitched sounds in the science of harmony and of musical composition were susceptible of such expression and adaptations, the engine might compose eloborate and scientific pieces of music of any degree of complexity or extent." (Hollings C, Martin U, Rice A, s.82)</p></div>
        ...
        <div className='text-gray-border'><p className='text-gray'>“If you can’t give me poetry, can’t you give me poetical science?”</p></div>
